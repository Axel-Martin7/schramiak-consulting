...
export default function AboutV2() {
  return (
    ...
    //              confiance et d un systeme de collaboration, en vue de contribuer
    //              a votre reussite ainsi qu a celle de vos clients.
    //            </p>
    //          </div>
    ...
    //            <p className={styles.role}>Consultant financier</p>
    //          </div>
