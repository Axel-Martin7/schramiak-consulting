...
export default function ParcoursPage({ params: { locale } }: Props) {
  ...
  return (
    ...
    //         <div className={styles.titlesContainer}>
    //           <h2 className={styles.cardName}>
    //             <strong className={styles.strong}>Master </strong>
    //             <span className={styles.line}>Contrôle de gestion </span>& Audit
    //             financier
    //           </h2>
    //         </div>
    //       </div>
    ...
    //     <div className={styles.carvedArrow}></div>
    //   </section>
    // </main>
        ...
        <article className={styles.card}>
          <div className={styles.cardInfosContainer}>
            ...
            <ul className={styles.cardDescriptionsList}>
              ...
              <li className={styles.description}>
                <span className={styles.bubble}></span>
                <p>Mise en place de process de d&apos;outils de reporting.</p>
              </li>
            </ul>
          </div>
